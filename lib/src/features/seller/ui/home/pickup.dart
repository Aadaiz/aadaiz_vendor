...
class _PickedupState extends State<Pickedup> {
  ...
  void initState() {
    ...
    super.initState();
    HomeController.to.getorderlist(isRefresh: true,type: 'pickup');
  }
  ...
  void onLoadMoreOrderApi() {
    if (HomeController.to.currentPage.value < HomeController.to.lastPage.value) {
      ...
      HomeController.to.getorderlist(isLoadMore: true,type: 'pickup');
    } else {
      HomeController.to.refreshControllerforPickup.loadNoData();
    }
  }
  @override
    ...
    return Obx(()=>
       SizedBox(
        ...
        child: SmartRefresher(
          controller: HomeController.to.refreshControllerforPickup,
          enablePullDown: true,
          ...
          Center(
            child: Image.asset('assets/dashboard/empty.png',
              ...
              itemBuilder: (BuildContext context,int index){
                ...
                return   OrderCard(buttonText1: '', buttonText2: 'Product Pickup ',type: 2,data:data);
              }),
        ),
      ),
    );
  ...
  @override
  void dispose() {
    // HomeController.to.refreshControllerforPickup.dispose();
    super.dispose();
  }
}
