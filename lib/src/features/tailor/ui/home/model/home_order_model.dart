...
class TailorOrderRes {
  ...
  factory TailorOrderRes.fromRawJson(String str) => TailorOrderRes.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory TailorOrderRes.fromJson(Map<String, dynamic> json) => TailorOrderRes(
...
class Datum {
  ...
  factory Datum.fromJson(Map<String, dynamic> json) => Datum(
    ...
    pattern: json["pattern"] == null ? null : Pattern.fromJson(json["pattern"]),
  );
